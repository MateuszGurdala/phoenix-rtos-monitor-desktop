...
import { DataRecordComponent } from './core/components/on-demand-data-page/data-record/data-record.component';
import {TimestampPipe} from "./feature/timestamp.pipe";
import {DataTypePipe} from "./feature/data-type.pipe";

@NgModule({
  declarations: [AppComponent, NavbarComponent, TabComponent, ThreadsMonitoringComponent, OnDemandDataComponent, RealTimeDataComponent, PageComponent, DataRecordComponent],
  imports: [
    BrowserModule,
    FormsModule,
    HttpClientModule,
